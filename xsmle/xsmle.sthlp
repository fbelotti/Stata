...
{phang}
{opt err:or(#)} defines the random effect error structure with # = 1..4. In particular, {cmd:error(1)} (the default) for for phi != lambda != 0, {cmd:error(2)} for phi != 0 and lambda == 0, 
{cmd:error(3)} for phi == 0 and lambda != 0 (SEM model), {cmd:error(4)} for phi == lambda.
